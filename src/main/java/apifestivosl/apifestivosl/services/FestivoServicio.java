package apifestivosl.apifestivosl.services;
...
import apifestivosl.apifestivosl.repositories.IFestivoRepo;
    ...
    private List<Festivo> calcularFestivos(List<Festivo> festivos, int año) {
        if (festivos != null) {
            ...
            for (final Festivo festivo : festivos) {
                ...
                System.out.println("dia " + festivo.getDia() + " fecha " + festivo.getFecha());
